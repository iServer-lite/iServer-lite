 ...
 */
define(['./when-8d13db60', './Check-70bec281', './Math-61ede240', './createTaskProcessorWorker', './FeatureDetection-7bd32c34', './Color-69f1845f', './pbf-0ab1b71f'], function (when, Check, _Math, createTaskProcessorWorker, FeatureDetection, Color, pbf) { 'use strict';
    ...
    //        });
       ...
       *         (Array.<number>|Array.<Array.<number>>),Object.<string,*>,number)}
        ...
        ol.format.MVT.prototype.readFeatures = function (source, opt_options) {
            ...
            var pbf$1 = new pbf.PBF(/** @type {ArrayBuffer} */ (source));
